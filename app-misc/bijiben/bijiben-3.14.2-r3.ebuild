...
src_prepare() {
	...
	# From GNOME:
	# 	https://gitlab.gnome.org/GNOME/gnome-notes/commit/437518dc7c35fd6563f435c66e9d0c078dc71b57
	# 	https://gitlab.gnome.org/GNOME/gnome-notes/commit/4b3974bfb94b057259932207c7ed85e26d999175
	# 	https://gitlab.gnome.org/GNOME/gnome-notes/commit/2c5a80bdc6a469153a7e8ca34ee6f4fa72e6a34a
	# 	https://gitlab.gnome.org/GNOME/gnome-notes/commit/2c5a80bdc6a469153a7e8ca34ee6f4fa72e6a34a
	# 	https://gitlab.gnome.org/GNOME/gnome-notes/commit/d7c4e2a2f14444258348927c1c280f874e1adf2e
	# 	https://gitlab.gnome.org/GNOME/gnome-notes/commit/f54ba1a2a21c8034c8db417c874cb357f6b67b78
	# 	https://gitlab.gnome.org/GNOME/gnome-notes/commit/d046440a517b33ff18a7bde309e7cf8be9d9d18d
	# 	https://gitlab.gnome.org/GNOME/gnome-notes/commit/6588b6b8576bbe2c355bd033ac1412453e4467f4
	...
	eapply "${FILESDIR}"/${PN}-3.15.1-move-bullets-and-ordered-list-to-popover.patch
	eapply "${FILESDIR}"/${PN}-3.15.2-drop-the-background-rows.patch
	...
	eapply "${FILESDIR}"/${PN}-3.17.1-icon-provide-a-symbolic-variant-of-the-app-icon.patch
	eapply "${FILESDIR}"/${PN}-3.17.1-icon-rename-hicolor-apps-scalable-bijiben-svg-to-bijiben-src-svg.patch
