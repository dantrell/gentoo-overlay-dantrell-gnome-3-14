...
src_prepare() {
	...
	# From GNOME:
	# 	https://gitlab.gnome.org/GNOME/gtk+/commit/c2330e7fd167618e9ec2c7f8137e545e328805f1
	# 	https://gitlab.gnome.org/GNOME/gtk+/commit/d39424fc1c0f7d876ccd9632f3b16d7a67aed290
	# 	https://gitlab.gnome.org/GNOME/gtk+/commit/66d25c4a060458001d4725aceb39a0a1a12db39a
	eapply "${FILESDIR}"/${PN}-3.15.0-add-3-16-version-macros.patch
	eapply "${FILESDIR}"/${PN}-3.15.0-gtklabel-add-x-yalign-properties.patch
	eapply "${FILESDIR}"/${PN}-3.15.10-gtk-label-set-yalign-fix-xalign-yalign-typo-in-parameter-name.patch

	# From GNOME:
	# 	https://gitlab.gnome.org/GNOME/gtk/commit/2e52e9964b5c0d463791b26bc0c17a162ea78495
	...
	if ! use vanilla-touchpad; then
		eapply "${FILESDIR}"/${PN}-3.15.10-gesture-on-cancel-remove-touchpoint-before-checking-the-recognized-state.patch
