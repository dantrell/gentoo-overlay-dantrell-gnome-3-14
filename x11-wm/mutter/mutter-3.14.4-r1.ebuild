...
src_prepare() {
	...
	# From GNOME:
	# 	https://gitlab.gnome.org/GNOME/mutter/-/commit/2c1f2fce402d98ad2670c4ccd72fd26a4d2a311d
	eapply "${FILESDIR}"/${PN}-3.16.4-window-remove-invalid-transfer-annnotations.patch
